...
const body = {
  ...
  eas_refer: "http%253A%252F%252Fseed.qq.com%252Fact%252Fa20220931yuyue%252F%253Freqid%253D09952238-1f07-4d23-8529-cd1d40884ec5%2526version%253D27",
...
const services = [exampleService, fetchService];
...
services.forEach((service) => {
  Object.entries(service.methods).forEach(([apiName, apiFn]) => {
    electron.ipcMain.handle(makeChannelName(service.name, apiName), (ev, ...args) => apiFn(...args));
  });
});
...
const createWindow = () => {
  const mainWindow = new electron.BrowserWindow({
    ...
    icon: path$1.join(__dirname, "../../assets/images/icon.png")
  });
  {
